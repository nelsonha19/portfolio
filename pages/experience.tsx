			...
			<Flex flexDir={'column'} mt={{ base: 2, md: 8 }}>
				<Flex flexDir={{ base: 'column-reverse', md: 'row' }}>
					<Flex flexDir={'column'} justifyContent={'center'} px={4}>
						...
						<Text>
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi similique ipsa alias ipsam
							cum, reiciendis nostrum repudiandae quos aut unde.
						</Text>
					</Flex>
					<Flex flexDir={'column'} flexGrow={1} alignItems={'center'}>
						<Image src="/commbank_ad.jpeg" alt="nelson in commbank ad" w={'600px'} borderRadius={'lg'} />
